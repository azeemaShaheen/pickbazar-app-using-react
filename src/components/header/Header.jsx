...
const Header = () => {
  // testing: false = login button, true = profile show
    ...
    <nav className="relative after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px">
        ...
        <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                <a
                  href="#"
                  aria-current="page"
                  className="rounded-md px-3 py-2 text-sm font-medium text-[#0B9376]"
                >
                  Dashboard
                </a>
                <a
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            {loggedIn ? (
              ...
              <button
                className="rounded-md bg-[#0B9376] px-4 py-2 text-sm font-medium text-white hover:opacity-90"
      ...
      <el-disclosure id="mobile-menu" hidden className="block sm:hidden">
        <div className="space-y-1 px-2 pt-2 pb-3">
          ...
          {/* mobile: login button too */}
          {!loggedIn && (
            <button className="mt-2 w-full rounded-md bg-[#0B9376] px-4 py-2 text-sm font-medium text-white hover:opacity-90">
              Login
            </button>
          )}
        </div>
